...
## Purpose
Admonitions add snippets of information without breaking the reading flow.
...
!!! note
    The types listed in this section will be trimmed down to the more relevant and commonly used ones.
    In the mean time, this section is a copy and paste job from the `mkdocs-material` documentation.
